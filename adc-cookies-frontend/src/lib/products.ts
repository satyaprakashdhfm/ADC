...
export const PRODUCT_DOCS: ProductDoc[] = [
  {
    ...
    story: 'Chocolate Chip is the cookie that sets the ADC standard: familiar, warm, and built around the smell of butter and chocolate. It is designed for customers who want a classic cookie that still feels bakery-made and premium.',
  ...
  },
  {
    ...
    story: 'Raagi is ADCs lighter, earthier cookie for customers who want a wholesome option without giving up the joy of a fresh bake. It keeps the bite soft while letting finger millet bring a naturally nutty character.',
  ...
  },
  {
    ...
    story: 'Matcha brings a calm, tea-forward flavor to the ADC menu. The cookie is built around a sweet-bitter balance, using white chocolate to round out the green tea notes without hiding them.',
  ...
  },
  {
    ...
    story: 'ADC Special is the signature cookie: the one that should taste like the brand in a single bite. It layers browned butter, multiple chocolates, and sea salt so the cookie feels indulgent without becoming flat or overly sweet.',
