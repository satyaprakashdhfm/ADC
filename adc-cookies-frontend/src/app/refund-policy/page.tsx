...
const SECTIONS: LegalSection[] = [
  {
    ...
    body: [
      'If something is wrong with your order, tell us and we will put it right — a replacement or a refund. We would rather fix it than argue about it.',
  ...
  },
  {
    ...
    body: [
      ...
      [
        ...
        'We cancelled it ourselves — an item ran out, a kitchen could not bake it, or we could not reach your address.',
      ],
