...
export default function FranchisePage() {
  return (
    <main className="adc-pattern-page" style={{ minHeight: '100vh' }}>
      ...
      {/* One consistent section — same background throughout, grouped as cards instead of
          alternating colour bands, so the page reads as a single flowing story. */}
      <section style={{ padding: 'clamp(28px,4vw,52px) var(--gutter) clamp(40px,6vw,72px)' }}>
        <div style={{ maxWidth: 1120, margin: '0 auto' }}>

          {/* Hero */}
          <div style={{ maxWidth: 760, margin: '0 auto clamp(32px,4.5vw,56px)', textAlign: 'center' }}>
          ...
          {/* How it works */}
          <div style={{ background: 'var(--surface-card)', border: '1px solid var(--border-default)', borderRadius: 'var(--radius-card)', boxShadow: 'var(--shadow-sm)', padding: 'clamp(24px,3.5vw,40px)', marginBottom: 'clamp(32px,4.5vw,56px)' }}>
            <div style={{ textAlign: 'center', marginBottom: 'clamp(20px,3vw,32px)' }}>
