...
export const metadata = {
  ...
  description: 'Find every ADC store across India — search, map and directions.',
};
    ...
    <main className="adc-pattern-page" style={{ minHeight: '100vh' }}>
      ...
      <section style={{ padding: 'clamp(24px,3.5vw,44px) var(--gutter) clamp(40px,5vw,72px)' }}>
        <div style={{ maxWidth: 1680, margin: '0 auto' }}>
          ...
          <h1 style={{ font: '900 clamp(1.9rem,1.3rem + 3vw,3.2rem)/1 var(--font-display)', letterSpacing: '-.02em', margin: '0 0 10px' }}>Find an ADC near you.</h1>
