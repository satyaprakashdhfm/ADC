...
export default function StoresAbout() {
  ...
  return (
    <>
      ...
      <section id="ingredients" style={band('#FFF0D7')}>
        <div style={inner}>
      ...
      <section id="stores" style={band('#FFFAF0')}>
        <div style={inner}>
          <div style={split}>
            <div style={col}>
              <div style={imgWrap}>
      ...
      <section id="get-in-touch" style={band('#FFF0CF', { borderBottom: '1px solid var(--border-default)' })}>
        <div style={inner}>
          {isMobile ? (
            <div>
              <button
