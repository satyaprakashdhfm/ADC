  ...
  return (
    <a
      ...
      style={{
        ...
        boxShadow: '0 12px 30px var(--wa-45), 0 4px 10px var(--black-18)',
        textDecoration: 'none',
      }}
    >
      {/* Pulsing ring */}
      <span
        ...
        style={{
          ...
          border: '2px solid var(--wa-60)',
          animation: 'waPulse 2.4s ease-out infinite',
        }}
      />
      <svg width={34} height={34} viewBox="0 0 32 32" aria-hidden style={{ fill: 'var(--white)' }}>
