'use client';
import { Users, UserPlus, ShoppingBag, Package, MessageSquare, IndianRupee, XCircle, RefreshCw, AlertTriangle, Undo2 } from 'lucide-react';
import { type AdminStats, type AdminAnalytics } from '@/lib/api';
import { money, fmtDate } from '../shared/format';
import { card, iconBtn, StatCard, Empty } from '../shared/ui';
